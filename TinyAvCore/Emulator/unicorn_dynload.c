...
// exe file, that loaded unicorn.dll, is in. This is standard behavior for
...
/*
dynload doesn't work with v0.9 of unicorn and unicorn have only v0.9 for windows in release tag.
I try to port this code to compatible with v0.9.
*/
...
#define DYNLOAD_LOADLIB(path, f)LoadLibraryExA(path, NULL, f)
...
{
	if (gp_uc_version == NULL) return UC_ERR_VERSION;
