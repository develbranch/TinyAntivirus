...
public:
	...
	*/
	virtual HRESULT WINAPI Read(__out LPVOID buffer, __in ULONG bufferSize, __out_opt ULONG * readSize) = 0;
	...
	@return: If the function succeeds, the return value is S_OK.
	*/
	virtual HRESULT WINAPI Write(__in const void * buffer, __in ULONG bufferSize, __out_opt ULONG * writtenSize) = 0;
